...
export const schema = {
  src: {type: 'text', label: 'Clip file (public/)', default: 'clips/current/scene-8.mp4'},
  startFromSeconds: {type: 'number', label: 'Clip start offset (s)', default: 4.8, min: 0, max: 8, step: 0.1},
  clipSeconds: {type: 'number', label: 'Source clip length (s)', default: 3.2, min: 1, max: 30, step: 0.5},
