...
export const schema = {
  ...
  quote: {type: 'text', label: 'Cliffhanger quote', default: 'खाने ने पहले पलक झपकाई.'},
  quoteAt: {type: 'number', label: 'Quote reveal (s, scene-local)', default: 2.8, min: 0, max: 10, step: 0.1},
  tease: {type: 'text', label: 'Part 2 tease', default: 'FOLLOW FOR TWISTS. SEND AT BEATASS.COM.'},
  teaseAt: {type: 'number', label: 'Tease reveal (s, scene-local)', default: 4.2, min: 0, max: 10, step: 0.1},
} as const;
