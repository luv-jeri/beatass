...
export const schema = {
  ...
  startFromSeconds: {type: 'number', label: 'Clip start offset (s)', default: 0.7, min: 0, max: 8, step: 0.1},
  clipSeconds: {type: 'number', label: 'Source clip length (s)', default: 7.3, min: 1, max: 30, step: 0.5},
